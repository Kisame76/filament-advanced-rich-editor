...
it('exposes the built-in tokens', function (): void {
    expect(array_keys(ToolbarLayout::tokens()))->toBe(['divider', 'headings', 'lists', 'alignment', 'fontSize']);
});
...
it('registers extra tokens from the config file', function (): void {
    ...
    expect(array_keys(ToolbarLayout::tokens()))->toBe(['divider', 'headings', 'lists', 'alignment', 'fontSize', 'inline'])
