...
it('exposes the built-in tokens', function (): void {
    expect(array_keys(ToolbarLayout::tokens()))->toBe(['divider', 'pin', 'headings', 'lists', 'alignment', 'callouts', 'language', 'characters', 'emoji', 'dateTime', 'formatBrush', 'indent', 'outdent', 'textCase', 'embed', 'lineHeight', 'more', 'tools', 'textColor', 'fullscreen', 'sourceCode', 'help', 'statistics', 'preview', 'find', 'accessibility', 'textBackground', 'styles', 'fontFamily', 'fontSize']);
});
...
it('registers extra tokens from the config file', function (): void {
    ...
    expect(array_keys(ToolbarLayout::tokens()))->toBe(['divider', 'pin', 'headings', 'lists', 'alignment', 'callouts', 'language', 'characters', 'emoji', 'dateTime', 'formatBrush', 'indent', 'outdent', 'textCase', 'embed', 'lineHeight', 'more', 'tools', 'textColor', 'fullscreen', 'sourceCode', 'help', 'statistics', 'preview', 'find', 'accessibility', 'textBackground', 'styles', 'fontFamily', 'fontSize', 'inline'])
