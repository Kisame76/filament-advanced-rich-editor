...
it('exposes the built-in tokens', function (): void {
    expect(array_keys(ToolbarLayout::tokens()))->toBe(['divider', 'pin', 'headings', 'lists', 'alignment', 'callouts', 'language', 'characters', 'embed', 'lineHeight', 'more', 'tools', 'textColor', 'fullscreen', 'sourceCode', 'help', 'find', 'accessibility', 'textBackground', 'styles', 'fontFamily', 'fontSize']);
});
...
it('registers extra tokens from the config file', function (): void {
    ...
    expect(array_keys(ToolbarLayout::tokens()))->toBe(['divider', 'pin', 'headings', 'lists', 'alignment', 'callouts', 'language', 'characters', 'embed', 'lineHeight', 'more', 'tools', 'textColor', 'fullscreen', 'sourceCode', 'help', 'find', 'accessibility', 'textBackground', 'styles', 'fontFamily', 'fontSize', 'inline'])
